...
public class Project9TestNG {
	...
	public void login() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable((By.xpath("//fa-icon[@class='collapsable-arrow ng-fa-icon ng-tns-c27-16 ng-star-inserted']"))));
		// Entrance Exam
		...
		wait.until(ExpectedConditions.elementToBeClickable((By.xpath("//div//span[@class='mat-select-placeholder ng-tns-c36-70 ng-star-inserted']"))));
